...
- Name: paper-wizard.spec.ts >> 组卷向导 E2E >> [E2E] 新建试卷向导页面加载 - 各步骤导航
- Location: tests/e2e/paper-wizard.spec.ts:18:3
