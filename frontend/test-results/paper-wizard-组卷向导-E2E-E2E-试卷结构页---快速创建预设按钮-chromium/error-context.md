...
- Name: paper-wizard.spec.ts >> 组卷向导 E2E >> [E2E] 试卷结构页 - 快速创建预设按钮
- Location: tests/e2e/paper-wizard.spec.ts:56:3
...
Locator: locator('text=基本信息').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=基本信息').first()
